...
% dydt(1) = vAK - vASADH ;
dydt(1) = Vak1 + Vak2 + VakI + VakII - Vasadh;
% dydt(2) = vASADH - vDHDPS - vHSDH ;
dydt(2) = Vasadh - Vdhdps1 -Vdhdps2- VhsdhI -VhsdhII ;
% dydt(3) = vDHDPS - vLKR ;
dydt(3) = Vdhdps1 + Vdhdps2 - Vlkr - VLys_tRNAS;
% dydt(4) = vHSDH - vHSK ;
dydt(4) = VhsdhI + VhsdhII -Vhsk;
% dydt(5) = Vhsk  - Vts1 - Vcgs; 
dydt(5) = Vhsk  - Vts1;
% dydt(6) = vTS1 - vTD - vThr_tRNAsth;
dydt(6) = Vts1 - Vtd - VThr_tRNAS;
